...
//    public FrameLayout searchServiceFrameLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRecentsFragment();
        setDayWordFragment();
        setSearchServiceFragment();


    }

    private void setDayWordFragment() {
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.day_word_container,DayWordFragment.newInstance())
                .addToBackStack(null)
                .commit();
    }

    private void setSearchServiceFragment() {
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.search_service_container,SearchServiceFragment.newInstance())
                .addToBackStack(null)
                .commit();
    }
